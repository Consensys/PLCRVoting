...
contract('Voting', (accounts) => {
  ...
  it("getAttribute gets previously set property correctly", () => {
    let voting;
    return PLCRVoting.deployed()
    .then((instance) => voting = instance)
  ...
  it("getCommitHash returns correct commitHash", () => {
    let voting;
    let hash;
    return PLCRVoting.deployed()
    .then((instance) => voting = instance)
  ...
  it("insertToDll inserts a new node correctly as the first element to a list originally of length 2", () => {
    let voting;
    let pollID = 5;
    let prevID = 0;
    let numTokens = 10;
  ...
  it("insertToDll inserts a new node correctly as the last element to a list originally of length 2", () => {
    let voting;
    let pollID = 5;
    let prevID = 2;
    let numTokens = 25;
  ...
  it("insertToDll inserts a new node correctly as the first element to an empty list", () => {
    let voting;
    let pollID = 20;
    let prevID = 0;
    let numTokens = 25;
